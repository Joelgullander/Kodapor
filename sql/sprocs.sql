...
-- The contents below should be identical to 'SECTION: Executable code' in reset_db.sql
-- Don't forget to copy and paste between files when making changes
--
-- This file is needed to complement import from mysqldump-file which doesn't include procedural code.
-- It is also needed for being able to update procedures without the need for creating a new database and new generatated data.
...
DROP PROCEDURE IF EXISTS fetch_meta_items$$
